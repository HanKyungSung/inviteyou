  ...
  return (
    <section className="contact">
      ...
      <ul className="contact-lists">
        <li className="contact-list">
          ...
          <ul className="contact-infos">
            <li className="contact-info tel">
              <a href={`tel:${groomTel}`}>{groomTel}</a>
            </li>
            <li className="contact-info email">
              <a href={`mailto:${groomEmail}`}>{groomEmail}</a>
            </li>
          </ul>
        ...
        <li className="contact-list">
          <figure className="character-img">
            <img src={groomImg} alt="bride-2" />
          </figure>
          <ul className="contact-infos">
            <li className="contact-info tel">
              <a href={`tel:${brideTel}`}>{brideTel}</a>
            </li>
            <li className="contact-info email">
              <a href={`mailto:${brideEmail}`}>{brideEmail}</a>
            </li>
          </ul>
          <figure className="tel-img" style={{ backgroundColor: mainColorRgb }}>
            <a href={`tel:${brideTel}`}>
