...
import musicFile from '../assets/music/SnapInsta.io - Frank Sinatra   I Love You Baby (128 kbps).mp3';
...
const SamHan = (props: SamHan) => {
  ...
  const [isAdultCountValidated, setIsAdultCountValidated] =
        ...
        >
          {modalInfo.submitInfo.rsvp === 'yes' ? (
            <div className="survey-comment">
              <Text size={18}>Thank you, See you on our Wedding day.</Text>
              <p
                style={{
                  color: '#2C4032',
                  fontWeight: 700,
              ...
              >
                ...
                <br />
                Number of Adult : {modalInfo.submitInfo.adultCount}
                <br />
                Number of Kid : {modalInfo.submitInfo.childCount}
                <br />
                Number of Total Attendees :{' '}
                {modalInfo.submitInfo.adultCount +
                  modalInfo.submitInfo.childCount}
                <br />
            ...
            <div className="survey-comment">
              <Text size={18}>Sorry to hear that! See you next time.</Text>
              <p
                style={{
                  color: '#2C4032',
                  fontWeight: 700,
        ...
        <main className={`${classes.invitationWrap} ${classes.invitationSam}`}>
          <Container className={classes.newVisual} fluid px={0}>
            <div className={classes.inr}>
              <Text
                className={classes.invitationTit}
                size={RESPONSIVE_MOBILE ? 14 : 18}
              >
              ...
              <div>
                <div className={classes.characterInfo}>
                  <Text
                    size={RESPONSIVE_MOBILE ? 30 : 50}
                    align="center"
                    pr={RESPONSIVE_MOBILE ? 180 : 130}
                  >
                    SAM HAN
                  </Text>
                  <Text
                    className={classes.and}
                    size={RESPONSIVE_MOBILE ? 145 : 245}
                  >
                    &
                  </Text>
                  <Text
                    size={RESPONSIVE_MOBILE ? 30 : 50}
                    align="center"
                    pl={RESPONSIVE_MOBILE ? 100 : 150}
                    pt={RESPONSIVE_MOBILE ? 20 : 30}
                  >
                    EUNHEE JO
                  </Text>
                </div>
          ...
          <Container className={classes.newIntro} py={50} px={0}>
            <div className={classes.sectionTitWrap}>
              <Text
                className={classes.sectionTit}
                size={RESPONSIVE_MOBILE ? 100 : 200}
                align="center"
              >
                opening
              </Text>
            ...
            <div className={classes.introMessage}>
              ...
              >
                ...
                <br />
                Please let us have the honor to host you on
                <br />
            ...
            <figure className={classes.introDeco1Figure}>
              <Image
                src={require('../assets/img/samhan/sam-intro-deco1.png')}
            ...
            <figure className={classes.introDeco2Figure}>
              <Image
                src={require('../assets/img/samhan/sam-intro-deco2.png')}
          ...
          <Container py={50} size={550}>
            <div>
              ...
              <div>
                ...
                <div className={classes.calendarWeddingSummary}>
                  June 17th, 2023 10:30 AM
                </div>
              </div>
            </div>
            ...
            <form onSubmit={(e) => handleFormSubmit(e)}>
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <Input.Wrapper className={classes.countInput}>
                  <label htmlFor="">
                    How many adults? <span style={{ color: 'red' }}>*</span>
                  </label>
                  <div className={classes.selectWrapper}>
                    <ActionIcon<'button'>
                      ...
                      variant="transparent"
                      onClick={() =>
                        adultCountInputHandlers.current?.decrement()
                      }
                    ...
                    <NumberInput
                      required
                      error={
                        adultCount == 0 && !initForm ? ADULT_COUNT_ERROR : ''
                      }
                      variant="unstyled"
                      min={min}
                      max={max}
                      ...
                      onChange={(count: number) =>
                        handleOnChnageAdultCount(count)
                      }
                    />
                    <ActionIcon<'button'>
                      size={28}
                      variant="transparent"
                      onClick={() =>
                        adultCountInputHandlers.current?.increment()
                      }
                ...
                <Input.Wrapper ml={5} className={classes.countInput}>
                  ...
                  <div className={classes.selectWrapper}>
                    <ActionIcon<'button'>
                      ...
                      variant="transparent"
                      onClick={() =>
                        childCountInputHandlers.current?.decrement()
                      }
                    ...
                    <ActionIcon<'button'>
                      ...
                      variant="transparent"
                      onClick={() =>
                        childCountInputHandlers.current?.increment()
                      }
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <Text size={14}>
                  Server will take your order on the wedding day
                </Text>
                {!isMenuOpen && (
                  <div>
                    <ul
                    ...
                    >
                      <li>
                        <div className={classes.menu}>
                          <Text size={16} color="#2C4032">
                            STARTER
                          </Text>
                          <Text size={16} weight={700}>
                            Shaughnessy Green Salad
                            <Text size={12} weight={400}>
                              crispy quinoa, julienne apple and carrots, pickled
                              radish, goat feta, toasted sunflower seeds, herb
                              vinaigrette
                            </Text>
                          </Text>
                        </div>
                        <div className={classes.menu}>
                          ...
                          <Text size={16} weight={700}>
                            Herb Pesto Steelhead
                            <Text size={12} weight={400}>
                              chive jasmine rice, seasonal vegetables, herb
                              pumpkin seed pesto, lemon bay laurel vin blanc
                            </Text>
                          </Text>
                          <Text size={16} weight={700}>
                            New York Striploin
                            <Text size={12} weight={400}>
                              grilled asparagus, rosemary whipped potato,
                              natural jus, crispy onions, chives
                            </Text>
                          </Text>
                          <Text size={16} weight={700}>
                            Roast Supreme Chicken
                            <Text size={12} weight={400}>
                              olive oil crushed potato, seasonal vegetables,
                              savory honey dijon glaze, bordelaise natural jus
                            </Text>
                          </Text>
                        </div>
                        <div className={classes.menu}>
                          ...
                          <Text size={16} weight={700}>
                            ...
                            <Text size={12} weight={400}>
                              fress berries, hazelnut praline
                            </Text>
                          </Text>
                        </div>
                      </li>
                  ...
                  <div className={classes.contactListLeft}>
                    ...
                    <ul style={{ marginLeft: 15 }}>
                      <li>
                        <Text
                          size={20}
                          className={classes.contactInfoName}
                          color="#888"
                        >
                          EUNHEE JO
                          <Text className="position" size={12}>
                            {' '}
                            / Bride
                          </Text>
                        </Text>
                      ...
                      <li style={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <Text
                          ...
                          ml={5}
                        >
                          <a href={`tel:778-686-9067`}>778. 686. 9067</a>
                        </Text>
                      </li>
                      <li style={{ display: 'flex', alignItems: 'center' }}>
                        <MdEmail
                    ...
                    <ul style={{ marginLeft: 15 }}>
                      ...
                      <li style={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <Text
                          ...
                          ml={5}
                        >
                          <a href={`tel:604-802-9953`}>604. 802. 9953</a>
                        </Text>
                      </li>
                      <li style={{ display: 'flex', alignItems: 'center' }}>
                        <MdEmail
